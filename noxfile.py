...
package = 'historic_weather_forecast'
python_versions = ['3.9']
...
def mypy(session: Session) -> None:
    ...
    args = session.posargs or ['historic_weather_forecast', 'tests', 'docs/conf.py']
    session.install('.')
...
def coverage(session: Session) -> None:
    ...
    nsessions = len(session._runner.manifest)  # type: ignore[attr-defined] # noqa: F821
