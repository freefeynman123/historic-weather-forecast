...
lint: ## check style with flake8
	flake8 historic-weather-forecast tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source historic-weather-forecast -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov\index.html

docs: ## generate Sphinx HTML documentation, including API docs
	del /f /q docs\historic-weather-forecast.rst
	del /f /q docs\modules.rst
	sphinx-apidoc -o docs historic-weather-forecast
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
